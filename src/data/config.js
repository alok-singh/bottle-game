...
const colors = [
  {
    ...
    description: "Green",
    value:
      "linear-gradient(to right, rgba(48, 254, 183, 1), rgba(48, 254, 183, 0.4) 10%, rgba(48, 254, 183, 1))",
  },
  {
    id: 2,
    description: "Violet",
    value:
      "linear-gradient(to right, rgba(100, 44, 180, 1), rgba(100, 44, 180, 0.4) 10%, rgba(100, 44, 180, 1))",
  },
  {
    id: 3,
    description: "Orange",
    value:
      "linear-gradient(to right, rgba(242, 138, 8, 1), rgba(242, 138, 8, 0.4) 10%, rgba(242, 138, 8, 1))",
  },
  {
    id: 4,
    description: "Yellow",
    value:
      "linear-gradient(to right, rgba(254, 246, 68, 1), rgba(254, 246, 68, 0.4) 10%, rgba(254, 246, 68, 1))",
  },
  {
    id: 5,
    description: "Brown",
    value:
      "linear-gradient(to right, rgba(121, 83, 74, 1), rgba(121, 83, 74, 0.4) 10%, rgba(121, 83, 74, 1))",
  },
  {
    id: 6,
    description: "Pink",
    value:
      "linear-gradient(to right, rgba(224, 41, 124, 1), rgba(224, 41, 124, 0.4) 10%, rgba(224, 41, 124, 1))",
  },
  {
    id: 7,
    description: "Red",
    value:
      "linear-gradient(to right, rgba(255, 1, 4, 1), rgba(255, 1, 4, 0.4) 10%, rgba(255, 1, 4, 1))",
  },
];
